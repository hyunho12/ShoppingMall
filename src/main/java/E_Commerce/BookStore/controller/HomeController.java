...
import E_Commerce.BookStore.service.*;
import E_Commerce.BookStore.service.impl.UserSecurityService;
import E_Commerce.BookStore.utility.MailConstructor;
import E_Commerce.BookStore.utility.SecurityUtility;
import E_Commerce.BookStore.utility.USConstants;
...
public class HomeController {
    ...
    public String myProfile(Model model, Principal principal){
        ...
        model.addAttribute("stageList",stateList);
    ...
    public String addNewShippingAddressPost(@ModelAttribute("userShipping") UserShipping userShipping, Principal principal,
                                            Model model){
        User user = userService.findByUsername(principal.getName());
    ...
    public String setDefaultShippingAddress(@ModelAttribute("defaultShippingAddressId") Long defaultShippingId, Model model,
                                            Principal principal){
        User user = userService.findByUsername(principal.getName());
