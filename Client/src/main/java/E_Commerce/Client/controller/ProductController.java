...
import E_Commerce.Client.service.CategoryService;
...
public class ProductController {
    ...
    public String viewProductDetail(@PathVariable("product_alias") String alias, Model model){
        try{
            ...
            Page<Review> listReviews = reviewService.listMostRecentReviewsByProduct(product);
    ...
    public String searchByPage(@Param("keyword") String keyword, @PathVariable("pageNum") int pageNum,
        ...
        model.addAttribute("endCount", endCount);
        model.addAttribute("totalItems", pageProducts.getTotalElements());
        model.addAttribute("pageTitle", keyword + " - 검색결과");
